 ...
 * Returns 0 for records older than RECENCY_MAX_MONTHS.
 */
...
/**
 * Percentile position of a value within a weighted distribution:
 * share of total weight strictly below the value, as 0–100.
 */
export function weightedPercentileRank(
  ...
  return Math.round((belowW / totalW) * 100);
}
